...
def del_item (daily_spending, deleted_item_name) :
        ...
        for i in daily_spending.copy() :
            ...
            elif days_counting_variable == number_of_day :
...
while True :        
    ...
    if choice == "1" :
        ...
        deleted_item_name = input("The date of daily spending day you want to deleted permanently...dd/mm or enter 'exit' if you want to return...")
