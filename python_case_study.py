...
oders.append(oders4)    
menu5 = Button(firts_frame, text="aquafina")
menu5.grid(row=2,  column=0,  padx=pdx,  pady=pdy)
menu6 = Button(firts_frame, text="pepsi")
menu6.grid(row=2,  column=1,  padx=pdx,  pady=pdy)
menu7 = Button(firts_frame,  text="coca")
menu7.grid(row=2, column=2, padx=pdx, pady=pdy)
menu8 = Button(firts_frame, text="7 up")
...
lam_moi_button = Button(firts_frame, text="lưu và làm mới", command=lam_moi)
